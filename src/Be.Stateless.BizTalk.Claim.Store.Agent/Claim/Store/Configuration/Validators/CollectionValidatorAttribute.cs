...
namespace Be.Stateless.BizTalk.Claim.Store.Configuration.Validators
{
	/// <summary>
	...
	public class CollectionValidatorAttribute : ConfigurationValidatorAttribute
	{
		...
		/// </returns>
		public override ConfigurationValidatorBase ValidatorInstance => new CollectionValidator();
