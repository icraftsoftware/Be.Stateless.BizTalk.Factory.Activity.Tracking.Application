...
namespace Be.Stateless.BizTalk.Activity.Tracking.Messaging
{
	...
	public partial class MessagingStep
	{
		...
		/// </summary>
		public virtual IBaseMessage Message => _message;
		...
		/// <summary>
		/// Captures the <see cref="IBaseMessage.Context"/> of the <see cref="IBaseMessage"/> being processed and associate it
		/// with its related BAM <c>MessagingStep</c> activity.
		/// </summary>
