...
namespace Be.Stateless.BizTalk.Activity.Tracking.Messaging
{
	...
	/// </summary>
	/// <remarks>
	/// Notice that, as this is a messaging-only activity factory API, there is no way to create a <see cref="ProcessingStep"/>
	/// activity.
	/// </remarks>
	public interface IActivityFactory
	{
		...
		/// </summary>
		/// <param name="message">
		/// The <see cref="IBaseMessage"/> to which will be attached the ambient <see cref="TrackingContext"/> referencing the
		/// activity id of the current <see cref="Process"/>.
		/// </param>
		/// <param name="name">
		...
		/// <summary>
		/// Creates a <see cref="ProcessReference"/> tracking activity denoting an already tracked, though possibly ongoing,
		/// process.
		/// </summary>
		...
		/// </summary>
		/// <param name="message">
		/// The <see cref="IBaseMessage"/> whose <see cref="IBaseMessage.BodyPart"/> and <see cref="IBaseMessageContext"/> data
		...
		/// </summary>
		/// <param name="trackingContext">
		/// The <see cref="TrackingContext"/> whose <see cref="TrackingContext.MessagingStepActivityId"/> identifies the already
		/// tracked <see cref="MessagingStep"/>.
		/// </param>
		/// <returns>
		/// A <see cref="MessagingStepReference"/> instance that will be used to feed the BAM Process activity: specifically,
		/// affiliating it to a <see cref="Process"/> tracking activity.
		/// </returns>
