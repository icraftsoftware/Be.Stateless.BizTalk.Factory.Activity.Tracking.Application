...
namespace Be.Stateless.BizTalk.Activity.Tracking
{
	...
	public static class ActivityId
	{
		...
		/// </returns>
		public static string AsNormalizedActivityId(this Guid id)
		{
			return id.ToString("N");
		}

		/// <summary>
		/// Normalize the string activity id to have a homogenous <see cref="Guid"/> format across all BAM tracking activities.
		/// </summary>
