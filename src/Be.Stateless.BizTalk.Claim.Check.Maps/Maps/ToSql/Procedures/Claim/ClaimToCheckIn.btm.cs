namespace Be.Stateless.BizTalk.Maps.ToSql.Procedures.Claim {
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"Be.Stateless.BizTalk.Schemas.Xml.Claim+CheckIn", typeof(global::Be.Stateless.BizTalk.Schemas.Xml.Claim.CheckIn))]
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"Be.Stateless.BizTalk.Schemas.Sql.Procedures.Claim.CheckIn", typeof(global::Be.Stateless.BizTalk.Schemas.Sql.Procedures.Claim.CheckIn))]
    public sealed class ClaimToCheckIn : global::Microsoft.XLANGs.BaseTypes.TransformBase {
...
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" version=""1.0""
  ...
  <xsl:template match=""clm:CheckIn"">
    <usp:usp_claim_CheckIn>
      ...
      <xsl:apply-templates select=""."" mode=""correlationId"" />
  ...
  <!-- correlationId -->
  <xsl:template match=""clm:CheckIn"" mode=""correlationId"">
    <xsl:if test=""ctxt:Read('bf:CorrelationId')"">
      <usp:correlationId>
        <xsl:value-of select=""ctxt:Read('bf:CorrelationId')"" />
      </usp:correlationId>
    </xsl:if>
  </xsl:template>
  <xsl:template match=""clm:CheckIn[clm:CorrelationId/text()]"" mode=""correlationId"">
    <usp:correlationId>
      <xsl:value-of select=""clm:CorrelationId/text()"" />
    </usp:correlationId>
  </xsl:template>
  ...
  <xsl:template match=""clm:CheckIn"" mode=""messageType"">
    <xsl:if test=""ctxt:Read('bf:MessageType')"">
      <usp:messageType>
        <xsl:value-of select=""ctxt:Read('bf:MessageType')"" />
      </usp:messageType>
    </xsl:if>
  </xsl:template>
  ...
  <xsl:template match=""@* | comment() | processing-instruction() | text()"" mode=""any"">
    <xsl:copy />
        ...
        private const string _strSrcSchemasList0 = @"Be.Stateless.BizTalk.Schemas.Xml.Claim+CheckIn";
        
        private const global::Be.Stateless.BizTalk.Schemas.Xml.Claim.CheckIn _srcSchemaTypeReference0 = null;
        
        private const string _strTrgSchemasList0 = @"Be.Stateless.BizTalk.Schemas.Sql.Procedures.Claim.CheckIn";
        
        private const global::Be.Stateless.BizTalk.Schemas.Sql.Procedures.Claim.CheckIn _trgSchemaTypeReference0 = null;
        ...
        public override string[] SourceSchemas {
            get {
                ...
                _SrcSchemas[0] = @"Be.Stateless.BizTalk.Schemas.Xml.Claim+CheckIn";
                return _SrcSchemas;
            }
        }
        ...
        public override string[] TargetSchemas {
            get {
                ...
                _TrgSchemas[0] = @"Be.Stateless.BizTalk.Schemas.Sql.Procedures.Claim.CheckIn";
                return _TrgSchemas;
            }
        }
    }
